...
8. À la sortie du mode cuisine, l'application affiche le temps passé et propose de mettre à jour `prepTimeMin` en prenant la moyenne entre le temps mesuré et la valeur existante de la recette.
